...
$("#addDataset").click(function(){
	var colorName = colorNames[config_densenet161_eval.data.datasets.length % colorNames.length];;
	var newColor = colorSet[colorName];

	var newDataset = {
		label: 'Dataset ' + config_densenet161_eval.data.datasets.length,
	...
	for (var index=0; index < config_densenet161_eval.data.labels.length; ++index) {
		newDataset.data.push(rnd100());
	}

	config_densenet161_eval.data.datasets.push(newDataset);
	chart_densenet161_eval.update();
});
...
$("#addData").click(function(){
	if (config_densenet161_eval.data.datasets.length > 0){
		config_densenet161_eval.data.labels.push('dataset #' + config_densenet161_eval.data.labels.length);
...
$("#removeDataset").click(function(){
	config_densenet161_eval.data.datasets.splice(0, 1);
	chart_densenet161_eval.update();
});
...
$("#removeData").click(function(){
	config_densenet161_eval.data.labels.pop(); // remove the label first
