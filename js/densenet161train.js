...
$("#addDataset").click(function(){
	var colorName = colorNames[config_densenet161_train.data.datasets.length % colorNames.length];;
	var newColor = colorSet[colorName];

	var newDataset = {
		label: 'Dataset ' + config_densenet161_train.data.datasets.length,
	...
	for (var index=0; index < config_densenet161_train.data.labels.length; ++index) {
		newDataset.data.push(rnd100());
	}

	config_densenet161_train.data.datasets.push(newDataset);
	chart_densenet161_train.update();
});
...
$("#addData").click(function(){
	if (config_densenet161_train.data.datasets.length > 0){
		config_densenet161_train.data.labels.push('dataset #' + config_densenet161_train.data.labels.length);
...
$("#removeDataset").click(function(){
	config_densenet161_train.data.datasets.splice(0, 1);
	chart_densenet161_train.update();
});
...
$("#removeData").click(function(){
	config_densenet161_train.data.labels.pop(); // remove the label first
